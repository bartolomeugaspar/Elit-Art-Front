          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                <div className="relative h-96 md:h-full min-h-96 bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                  <Image
              ...
              <div className="space-y-6">
                ...
                {/* Title */}
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-elit-dark mb-2">
                    {artwork.title}
                  </h1>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center gap-3 mb-2">
                    <User size={20} className="text-elit-red" />
                    <span className="font-semibold text-elit-dark">Artista</span>
                  </div>
                  <p className="text-elit-dark/70">{artwork.artist_name}</p>
                </div>

                {/* Year */}
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center gap-3 mb-2">
                    <Calendar size={20} className="text-elit-red" />
                    <span className="font-semibold text-elit-dark">Ano</span>
                  </div>
                  <p className="text-elit-dark/70">{artwork.year}</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      <Eye size={18} className="text-elit-red" />
                      <span className="font-semibold text-elit-dark">{artwork.views || 0}</span>
                    </div>
                    <p className="text-xs text-elit-dark/60">Visualizações</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      <Heart size={18} className={liked ? 'fill-elit-red text-elit-red' : 'text-elit-red'} />
                      <span className="font-semibold text-elit-dark">{(artwork.likes || 0) + (liked ? 1 : 0)}</span>
                    </div>
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <button
                    onClick={handleShare}
                    className="w-full px-4 py-3 bg-elit-orange text-white rounded-lg font-semibold hover:bg-elit-brown transition flex items-center justify-center gap-2"
                  >
                    <Share2 size={20} />
                    Compartilhar
                  </button>
            ...
            <div className="mt-12 bg-white rounded-lg p-8 border border-gray-200">
              <h2 className="text-2xl font-bold text-elit-dark mb-4">Sobre a Obra</h2>
            ...
            {/* Related Works */}
            <div className="mt-12">
              <h2 className="text-2xl font-bold text-elit-dark mb-6">Mais Obras do Artista</h2>
              <Link
                href={`/galeria?artist=${artwork.artist_name}`}
                className="inline-flex items-center gap-2 px-6 py-3 bg-elit-red text-white rounded-lg hover:bg-elit-brown transition font-semibold"
              >
